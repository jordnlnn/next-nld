  ...
  return (
    <div>
      <div className="min-h-screen w-full nld-bg-blue-800 bg-cover bg-bottom lg:bg-right bg-no-repeat bg-[url('https://d75cfcm8x0ifj.cloudfront.net/map-bg-mobile-3-stars.jpg')] lg:bg-[url('https://d75cfcm8x0ifj.cloudfront.net/map-bg-stars.jpg')]">
        <div className="max-w-7xl m-auto grid grid-cols-1 lg:grid-cols-2 text-left px-4 lg:px-12 items-start lg:items-center h-screen">
          <div className="pt-40 lg:pt-0">
            <p className="nld-font-jost nld-font-h2 nld-text-grey-200">
              {t("welcome")}
            </p>
            <h2 className="nld-font-jost nld-font-display-mobile lg:text-80px/[96px] lg: mt-4">
              {t("native-land-digital")}
            </h2>
            ...
            <div className="mt-4 grid grid-cols-1 lg:grid-cols-6 gap-4 w-full">
              ...
              <div className="col-span-1 lg:col-span-2">
                <Link
                  prefetch={false}
                  href="/maps/constellation"
                  className="block rounded-full nld-bg-green-500 nld-text-grey-500 font-semibold px-4 py-2.5 text-center"
                >
                  {t("explore-map")}
                </Link>
                <div className="text-center mt-2.5">
                  <Link
                    className="text-[14px] italic nld-text-grey-200"
                    href="/maps/native-land"
                    prefetch={false}
                  >
                    or visit the classic map
                  </Link>
                </div>
              </div>
            </div>
      ...
      <div className="nld-bg-teal-500">
        <div className="max-w-7xl m-auto grid grid-cols-1 lg:grid-cols-3 p-4 lg:p-12 py-20 gap-0 lg:gap-12">
          <div className="col-span-1 border-0 lg:border-r lg:border-white/20">
            <h2 className="nld-font-jost nld-font-h1 text-white font-semibold">
              {t("welcome-glad")}
            </h2>
            <p className="nld-font-md text-white mt-8">
              {t("welcome-contact")}
            </p>
            <Link
              prefetch={false}
              href="/contact"
              className="inline-block mt-4 px-6 py-3 text-center text-white border border-white nld-button-md rounded-full"
            >
              {tNav("contact")}
            </Link>
          </div>
          <div className="col-span-2">
            ...
            <h3 className="nld-font-jost nld-font-h2 text-white font-medium">
              {t("welcome-blurb-2")}
            </h3>
            <hr className="border-white/20 my-8" />
            <div className="mt-4 grid grid-cols-2 lg:grid-cols-3 gap-8">
              <div>
                <h3 className="nld-font-jost text-center nld-font-h3 text-white font-medium">
                  100M+
                </h3>
      ...
      <div
        ...
        style={{
          backgroundImage:
            "url('https://d75cfcm8x0ifj.cloudfront.net/river-bg-small-trans.png')",
        }}
      >
        <div className="max-w-7xl m-auto grid grid-cols-1 lg:grid-cols-2 py-36 px-4 lg:px-16 gap-12">
          <div className="items-center flex h-full">
            <div>
              <h2 className="nld-font-jost nld-font-h2 nld-text-grey-500 font-medium">
                {t("our-mission-header")}
              </h2>
              <p className="nld-font-lg nld-text-grey-500 mt-4">
                {t("our-mission")}
              </p>
              <div className="mt-8">
                <Link
                  prefetch={false}
                  className="nld-text-grey-500 rounded-full border border-black px-4 py-2.5 font-semibold inline-flex items-center"
          ...
          <div>
            <img
              src="https://d75cfcm8x0ifj.cloudfront.net/mission-small.png"
              alt="Mission"
      ...
      <div className="nld-bg-yellow-500 py-4">
        <div className="max-w-7xl m-auto pt-16">
          <h2 className="nld-font-jost nld-font-h2 nld-text-grey-500 font-medium text-center">
        ...
        <div className="max-w-7xl m-auto grid grid-cols-1 lg:grid-cols-3 p-12 px-12 gap-8">
          ...
          <div className="nld-bg-grey-50 rounded-lg text-center p-4">
            ...
            <p className="nld-font-lg mt-4 nld-text-grey-500">
              <span dangerouslySetInnerHTML={{ __html: t("education") }} />
            </p>
          </div>
        </div>
      </div>
      <div className="bg-white">
        ...
        <div className="max-w-7xl m-auto grid grid-cols-1 lg:grid-cols-2 p-12 px-12 gap-12">
          <div
            className="nld-bg-grey-50 rounded-lg p-4 bg-no-repeat bg-right-top"
            style={{
              backgroundImage:
                "url('https://d75cfcm8x0ifj.cloudfront.net/main-globe-cut.png')",
            }}
          >
            <div className="w-full lg:w-1/2">
              <h3 className="nld-font-jost nld-font-h3 nld-text-grey-500 font-medium">
                {t("native-land-map")}
              </h3>
              <p className="bg-slate-100/50 p-2.5 lg:p-0 rounded-xl lg:bg-transparent nld-font-lg mt-4 nld-text-grey-500">
                {t("native-land-map-blurb")}
              </p>
              <div className="mt-8">
                <Link
                  prefetch={false}
                  className="bg-slate-100/50 lg:bg-transparent nld-text-grey-500 rounded-full border border-black px-4 py-2.5 font-semibold items-center inline-flex"
                  href="/maps/native-land"
                >
                  {t("view-map")}
                  <svg
          ...
          <div
            ...
            style={{
              backgroundImage:
                "url('https://d75cfcm8x0ifj.cloudfront.net/placename-globe-cut.png')",
            }}
          >
            <div className="w-full lg:w-1/2">
              <h3 className="nld-font-jost nld-font-h3 nld-text-grey-500 font-medium">
              ...
              <p className="bg-slate-100/50 p-2.5 lg:p-0 nld-font-lg mt-4 nld-text-grey-500">
                {t("placenames-map-blurb")}
              </p>
              <div className="mt-8">
                <Link
                  prefetch={false}
                  className="bg-slate-100/50 lg:bg-transparent nld-text-grey-500 rounded-full border border-black px-4 py-2.5 font-semibold items-center inline-flex"
                  href="/maps/placenames"
                >
                  {t("view-map")}
                  <svg
                    className="ml-2.5 inline"
      ...
      <div className="bg-white">
        ...
        <div className="max-w-7xl m-auto grid grid-cols-1 lg:grid-cols-3 py-12 p-4 lg:px-12 gap-12">
          <div className="border-0 lg:border-r-2 nld-border-teal-100">
            ...
            <p className="nld-font-lg mt-4 nld-text-grey-500 pr-4">
              <span dangerouslySetInnerHTML={{ __html: t("open-data") }} />
            </p>
            <div className="mt-8">
              <Link
                prefetch={false}
                className="nld-text-grey-500 rounded-full border border-black px-4 py-2.5 font-semibold items-center inline-flex"
          ...
          <div className="border-0 lg:border-r-2 nld-border-teal-100">
            ...
            <p className="nld-font-lg mt-4 nld-text-grey-500 pr-4">
              <span dangerouslySetInnerHTML={{ __html: t("research") }} />
            </p>
            <div className="mt-8">
              <Link
                prefetch={false}
          ...
          <div>
            ...
            <p className="nld-font-lg mt-4 nld-text-grey-500">
              <span dangerouslySetInnerHTML={{ __html: t("blogs") }} />
            </p>
            <div className="mt-8">
              <Link
                prefetch={false}
                className="nld-text-grey-500 rounded-full border border-black px-4 py-2.5 font-semibold items-center inline-flex"
                href="https://medium.com/@native-land"
              >
                {t("blog-link")}
                <svg
                  className="ml-2.5 inline"
      ...
      <div
        className="nld-bg-teal-600 py-8 bg-cover bg-no-repeat"
        style={{
          backgroundImage:
            "url('https://d75cfcm8x0ifj.cloudfront.net/water-bg-small-trans.png')",
        }}
      >
        <div className="max-w-7xl m-auto px-4 lg:px-16 pt-16 text-center">
          <h2 className="nld-font-jost nld-font-h2 text-white font-medium">
            {t("where-you-stand")}
          </h2>
          <p className="nld-font-lg text-white mt-4">
            {t("where-you-stand-blurb")}
          </p>
        </div>
        <div
          className="max-w-7xl m-auto m-auto my-8 px-4 lg:w-4/5 lg:w-2/3 rounded-lg lg:p-8 !bg-none lg:bg-cover lg:bg-no-repeat lg:bg-center"
          style={{
            backgroundImage:
              "url('https://d75cfcm8x0ifj.cloudfront.net/waterfall-bg.jpg')",
          }}
        >
          <div className="rounded-lg bg-white/90 p-4">
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="nld-font-h3 nld-text-grey-300">
                  {t("korero-subheader")}
                </p>
              </div>
            </div>
            <p className="nld-text-grey-500 nld-font-lg mt-4">
              {t("korero-text-1")}
            </p>
            <p className="nld-text-grey-500 nld-font-lg mt-4">
              {t("korero-text-2")}
            ...
            <img
              ...
              src="https://d75cfcm8x0ifj.cloudfront.net/ai-chat.png"
            />
          </div>
        </div>
        <div className="text-center pb-16">
          <Link
            prefetch={false}
            className="text-white rounded-full border border-white px-4 py-2.5 font-semibold items-center inline-flex"
      ...
      <div className="nld-bg-grey-50">
        <div className="max-w-7xl m-auto px-4 lg:px-16 pt-16 text-center">
          ...
          <p className="mt-4">
            <a
              className="nld-text-teal-500 font-semibold"
              href="https://native-land.ca/about/partners-and-contributors"
            >
              {t("our-partners-link")}
            </a>
          </p>
        ...
        <div className="max-w-7xl m-auto grid grid-cols-1 lg:grid-cols-3 gap-8 w-2/3 m-auto mt-8">
          <div>
            <a href="https://mapbox.com/">
              <img
                ...
                src="https://d75cfcm8x0ifj.cloudfront.net/mapbox-logo.webp"
                alt="Mapbox logo"
              />
            </a>
          </div>
          <div>
            <a href="https://www.vancity.com/">
              <img
                className="m-auto w-40"
                src="https://d75cfcm8x0ifj.cloudfront.net/vancity-logo.webp"
                alt="Vancity logo"
              />
            </a>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8 w-2/3 m-auto mt-8 pb-16">
          ...
          <div>
            <a href="https://mapster.me/">
              <img
                className="m-auto w-40"
                src="https://d75cfcm8x0ifj.cloudfront.net/mapster-tech-logo.webp"
                alt="Mapster Technology Inc logo"
              />
            </a>
          </div>
          <div className="flex items-center">
            <a href="https://awana.digital/">
              <img
                className="m-auto"
                src="https://d75cfcm8x0ifj.cloudfront.net/awana-digital-logo.png"
                alt="Awana Digital logo"
              />
            </a>
          </div>
          <div></div>
      ...
      <div
        className="bg-white py-24 pb-40 bg-cover bg-no-repeat"
        style={{
          backgroundImage:
            "url('https://d75cfcm8x0ifj.cloudfront.net/river-bg-small-trans.png')",
        }}
      >
        <div className="max-w-7xl m-auto px-4 lg:px-16 pt-16 text-center">
          ...
          <p className="mt-4">
            <a className="nld-text-teal-500 font-semibold" href="">
              {t("help-nld-link")}
            </a>
          </p>
        </div>
        <div className="max-w-7xl m-auto grid grid-cols-1 lg:grid-cols-2 gap-8 px-4 lg:px-0 mt-8">
          <div className="nld-bg-green-500 rounded-lg p-8">
            <div className="flex">
              ...
              >
                <path
                  d="M32.1623 10.503C32.1623 6.01731 28.6923 2.36429 24.6352 1.04813C19.5905 -0.590355 12.9443 -0.348611 8.11314 1.93452C2.26768 4.70115 0.452653 10.7716 0.372578 16.8421C0.319195 21.8112 0.799645 34.946 8.16652 35.0266C13.6383 35.1071 14.439 28.016 16.9747 24.6047C18.7631 22.1873 21.0852 21.4889 23.9412 20.7905C28.8525 19.5818 32.1889 15.6871 32.1623 10.5299V10.503Z"
                  fill="#23282B"
                />
              </svg>
              <h2 className="uppercase nld-font-h3 nld-text-grey-500 ml-4">
                {t("patreon-header")}
              </h2>
            </div>
            ...
            <div className="mt-4">
              <Link
                prefetch={false}
                className="nld-text-grey-500 rounded-full border border-black px-4 py-2.5 font-semibold items-center inline-flex"
                href="https://www.patreon.com/nativeland"
                target="_blank"
                rel="noopener noreferrer"
              >
                {t("patreon-link")}
          ...
          <div className="nld-bg-yellow-500 rounded-lg p-8">
            <h2 className="nld-font-h3 nld-text-grey-500 font-semibold">
              {t("supporters-circle-header")}
            </h2>
            <p className="mt-4 nld-text-grey-500 nld-font-lg">
              {t("supporters-circle")}
            </p>
            <div className="mt-4">
              <Link
      ...
      <div
        className="p-4 lg:p-16 bg-cover"
        style={{
          backgroundImage:
            "url('https://d75cfcm8x0ifj.cloudfront.net/low-light-hills.jpg')",
        }}
      >
        <div className="max-w-7xl m-auto rounded-xl bg-white p-8 w-full">
          <h2 className="nld-font-h3 nld-text-teal-500 flex items-center font-semibold">
            ...
            >
              <path
                d="M19.0001 17.3332C19.9206 17.3332 20.6667 18.0794 20.6667 18.9998V25.6665C20.6667 26.587 19.9206 27.3332 19.0001 27.3332C18.0796 27.3332 17.3334 26.587 17.3334 25.6665V18.9998C17.3334 18.0794 18.0796 17.3332 19.0001 17.3332Z"
                fill="#29646F"
              />
              <path
                d="M19.0164 10.6665C19.9368 10.6665 20.683 11.4127 20.683 12.3332C20.683 13.2536 19.9368 13.9998 19.0164 13.9998H19.0001C18.0796 13.9998 17.3334 13.2536 17.3334 12.3332C17.3334 11.4127 18.0796 10.6665 19.0001 10.6665H19.0164Z"
                fill="#29646F"
              />
              <path
                fill-rule="evenodd"
                clip-rule="evenodd"
                d="M19.0001 0.666504C29.1253 0.666504 37.3334 8.87462 37.3334 18.9998C37.3334 29.1251 29.1253 37.3332 19.0001 37.3332C8.87486 37.3332 0.666748 29.1251 0.666748 18.9998C0.666748 8.87462 8.87486 0.666504 19.0001 0.666504ZM19.0001 3.99984C10.7158 3.99984 4.00008 10.7156 4.00008 18.9998C4.00008 27.2841 10.7158 33.9998 19.0001 33.9998C27.2844 33.9998 34.0001 27.2841 34.0001 18.9998C34.0001 10.7156 27.2844 3.99984 19.0001 3.99984Z"
                fill="#29646F"
              />
            </svg>
            {t("disclaimer-header")}
          ...
          <div
            className="mt-4 nld-text-grey-500 nld-disclaimer"
